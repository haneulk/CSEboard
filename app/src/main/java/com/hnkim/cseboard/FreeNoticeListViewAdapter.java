...
public class FreeNoticeListViewAdapter extends BaseAdapter implements Filterable{
    private Context mContext = null;
    public static ArrayList<FreeNoticeListData> noticeData = new ArrayList<FreeNoticeListData>();
    public ArrayList<FreeNoticeListData> filteredItemList = noticeData;

    Filter listFilter;

    public FreeNoticeListViewAdapter(Context context) {
        super();
        mContext = context;
    }
...
//            noticeListData mData = noticeData.get(position);
        FreeNoticeListData mData = filteredItemList.get(position);
    ...
    private class ListFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if(constraint == null || constraint.length() == 0) {
                ...
                ArrayList<FreeNoticeListData> itemList = new ArrayList<FreeNoticeListData>();
                for(FreeNoticeListData item : noticeData) {
...
//                        Spannable spanText = Spannable.Factory.getInstance().newSpannable(filteredItemList.get(position).getTitle())
        ...
        protected void publishResults(CharSequence contraint, FilterResults results) {
            filteredItemList = (ArrayList<FreeNoticeListData>) results.values;
