...
//번호 ListViewAdapter
public class FreeNumberListViewAdapter extends BaseAdapter implements Filterable {
    private Context mContext = null;
    public static  ArrayList<FreeNumberListData> numberData = new ArrayList<FreeNumberListData>();
    public ArrayList<FreeNumberListData> filteredItemList2 = numberData;



    Filter listFilter2;

    public FreeNumberListViewAdapter(Context context) {
        super();
        mContext = context;
...
//    public String getTitle() { return numberData.}
    ...
    public View getView(int position, View v, ViewGroup parent) {
        ...
        FreeNumberListData mData = filteredItemList2.get(position);
...
//        }
    ...
    public Filter getFilter() {
        if(listFilter2 == null) {
            listFilter2 = new FreeNumberListViewAdapter.ListFilter();
        }
        return listFilter2;
    }
    ...
    private class ListFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if(constraint == null || constraint.length() == 0) {
                ...
                ArrayList<FreeNumberListData> itemList2 = new ArrayList<FreeNumberListData>();
                for(FreeNumberListData item : numberData) {
        ...
        protected void publishResults(CharSequence contraint, FilterResults results) {
            filteredItemList2 = (ArrayList<FreeNumberListData>) results.values;
